...
* Thymeleaf (para o mecanismo de templates)<br/>
* Verificar se tem o Java 17 e o apache maven instalado
* executar
*    mvn clean install   - reiniciar o maven
*    mvn spring-boot:run  - iniciar o maven
